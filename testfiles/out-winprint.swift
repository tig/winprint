...
SYNTAX
    ...
    Out-WinPrint [[-PrinterName] <string>] [-Sheetdefinition <string>] [-Landscape {No | Yes}] [-LineNumbers {No | Yes}] [-ContentTypeEngine <string>] [-FileName <string>] [-Title <string>] [-InputObject <psobject>] [-WhatIf] [<CommonParameters>]
