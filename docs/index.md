...
Advanced source code and text file printing for terminals (all platforms) and Windows/macOS GUIs. The perfect tool for printing source code, Markdown, web pages, reports generated by legacy systems, documentation, or any text or HTML file.
