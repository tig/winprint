...
namespace WinPrint.Views
{
    public sealed partial class MainPage : Page
    {
        ...
        private void UpdateStatus(string strMessage, NotifyType type)
        {
            ...
            //        StatusBlock.Background = new SolidColorBrush(Windows.UI.Colors.Green);
            //        break;
            //    case NotifyType.ErrorMessage:
            //        StatusBlock.Background = new SolidColorBrush(Windows.UI.Colors.Red);
            //        break;
            //}
        ...
        private void SizeChanged(object sender, Windows.UI.Xaml.SizeChangedEventArgs e)
        {
            ...
            double aspectRatio = 11 / 8.5;

            PagePreview.Width = e.NewSize.Height * aspectRatio;

            if ((PagePreview.Width / aspectRatio) <= e.NewSize.Height)
            {
                PagePreview.Width = e.NewSize.Height * aspectRatio;
            }
            PagePreview.Height = PagePreview.Width / aspectRatio;
        }
        ...
        public async Task ShowPrintUIAsync()
        {
            ...
            {
                NotifyUser("Error printing: " + e.Message + ", hr=" + e.HResult, NotifyType.ErrorMessage);
            }
        }
            ...
            printTask = e.Request.CreatePrintTask("C# Printing SDK Sample", sourceRequested =>
            {
                ...
                printTask.Completed += async (s, args) =>
                {
                    ...
                    if (args.Completion == PrintTaskCompletion.Failed)
                    {
                        ...
                        {
                            NotifyUser("Failed to print.", NotifyType.ErrorMessage);
                        });
                    }
                };
