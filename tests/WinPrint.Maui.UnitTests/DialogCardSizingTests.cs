...
public class DialogCardSizingTests
{
    ...
    public void TallWindow_KeepsPreferredSize()
    {
        ...
        Assert.Equal(Preferred, DialogCardSizing.ClampToWindow(Preferred, 1000));
    }
    ...
    public void ShortWindow_ShrinksCardToFitWithinMargins()
    {
        ...
        double result = DialogCardSizing.ClampToWindow(Preferred, 430);
    ...
    public void TinyWindow_DoesNotCollapseBelowMinimum()
    {
        ...
        Assert.Equal(DialogCardSizing.MinLength, DialogCardSizing.ClampToWindow(Preferred, 40));
    }
    ...
    public void UnmeasuredWindow_UsesPreferredSize()
    {
        ...
        Assert.Equal(Preferred, DialogCardSizing.ClampToWindow(Preferred, 0));
    }
