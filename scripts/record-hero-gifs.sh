...
# to "Proportional 1-Up" → set Content Font to 12pt → page 5× + Home → quit (Esc → Don't Save).
...
# at row 26 when expanded, OK at row 27). Switching the sheet RELOADS the document, so give it a long
